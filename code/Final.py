...
cmdBrowse = Tkinter.Button(text="Browse",width=5,height=1,command = browse_cmd, bg='red',fg='black')

status = Tkinter.Label(wraplength=200,width=30,pady=3,padx=3,anchor="w",bg='white',fg='blue')
status_op = Tkinter.Label(wraplength=300,width=30,pady=3,padx=3,anchor="w",bg='white',fg='blue')
...
btlabel3 = Tkinter.Label(text="QA SYSTEM IN MALAYALAM DOCUMENTS", bg='green',fg='black')
